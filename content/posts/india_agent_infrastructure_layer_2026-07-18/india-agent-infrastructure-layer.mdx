...
description: "Emergent's $1.5B round, HCLTech's ₹3,500 crore data centers, and Karnataka's policy point at one gap: India's missing agent infrastructure layer."
date: 2026-07-18
lastUpdated: "2026-07-19"
slug: "/india-agent-infrastructure-layer"
canonicalUrl: "https://adityakarnam.com/india-agent-infrastructure-layer/"
banner: "./banner-data-center.jpg"
keywords:
  [
...
![Close-up of a hand racking a server in a blue-lit data center](./banner-data-center.jpg)

> **Key Takeaways**
> - Emergent hit a $1.5B valuation just over a year after launch, a five-fold jump from its $300M valuation six months earlier ([TechCrunch](https://techcrunch.com/2026/07/15/indian-ai-coding-startup-emergent-becomes-a-unicorn-just-over-a-year-after-launch/), 2026).
> - HCLTech approved up to ₹3,500 crore for AI data centers scaling to 50 MW, run through a new subsidiary ([HCLTech](https://www.hcltech.com/press-releases/hcltech-launches-full-stack-ai-offering-powered-new-ai-data-center-investment), 2026).
...
- Bengaluru-based **Emergent** raised a $130 million Series C led by Creaegis at a $1.5 billion valuation, becoming a unicorn a little over a year after launching in June 2025 — a five-fold jump from its $300 million valuation just six months earlier in its January 2026 Series B ([TechCrunch](https://techcrunch.com/2026/07/15/indian-ai-coding-startup-emergent-becomes-a-unicorn-just-over-a-year-after-launch/), [CNBC](https://www.cnbc.com/2026/07/16/catching-up-in-the-ai-race-india-gets-its-second-ai-unicorn-in-a-month.html)).
- **HCLTech**'s board approved up to ₹3,500 crore for full-stack AI data centers reaching 50 MW capacity, run through a new subsidiary and step-down subsidiaries built specifically for the business ([HCLTech](https://www.hcltech.com/press-releases/hcltech-launches-full-stack-ai-offering-powered-new-ai-data-center-investment), [Times of India](https://timesofindia.indiatimes.com/business/india-business/hcltech-to-up-ai-game-invest-3500-crore-in-data-centres-of-up-to-50-mw/articleshow/132378824.cms)).
- **Karnataka** confirmed it is finalizing a comprehensive data-center policy covering land, power, and water, alongside a concrete plan — announced by CM Shivakumar at Google I/O Connect — to build "India's first and largest public sector-led AI University" on roughly 100 acres ([The Federal](https://thefederal.com/category/states/south/karnataka/karnataka-to-roll-out-data-centre-policy-to-power-ai-growth-next-gen-computing-250250), [Economic Times](https://m.economictimes.com/news/india/karnataka-finalising-comprehensive-data-centre-policy-to-support-ai-infrastructure/articleshow/132418412.cms)).
- **TCS** opened its Autonomous Engineering Lab, powered by Nvidia, at its Global Axis campus in Bengaluru, aimed at moving industrial AI in mobility and manufacturing from prototype to production ([TCS](https://www.tcs.com/who-we-are/newsroom/press-release/tcs-launches-industrial-ai-solutions-lab-bengaluru-powered-nvidia), [Business Standard](https://www.business-standard.com/companies/news/tcs-nvidia-launch-industrial-ai-solutions-lab-bengaluru-manufacturing-mobility-126071500551_1.html)).
- **Mandrake Bio**, a Bengaluru biotech startup founded in March 2025, raised ₹16 crore ($1.9M) pre-seed co-led by Activate and Antler to design gene-editing enzymes from scratch with generative AI, rather than modifying existing systems like CRISPR-Cas9 ([Economic Times](https://m.economictimes.com/tech/artificial-intelligence/mandrake-bio-raises-rs-16-crore-to-build-ai-powered-gene-editing-platform-for-agriculture-medicine/articleshow/132431719.cms), [Entrackr](https://entrackr.com/snippets/mandrake-bio-raises-rs-16-cr-in-pre-seed-round-co-led-by-activate-and-antler-12170217)).
...
I've spent the last few months building exactly this layer, at small scale, because I kept running into the same wall: the model isn't the bottleneck, the harness is. Some of that work overlaps with what I've written about separately on [memory and retrieval infrastructure](/embenx-python-embedding-toolkit/) and the broader case for [a world-model infrastructure layer](/field-notes/) underneath agents.

![An engineer connecting network cables to a server rack switch](./inline-fiber-engineer.jpg)
...
Separately, I built [subagent-fleet](https://github.com/adityak74/subagent-fleet) ([full write-up here](/subagent-fleet-local-ai-compute-control-plane/)), a control plane for routing Claude Code-style subagents across local Ollama nodes, because a fleet of machines with different models on them isn't automatically a coordinated backend — someone has to decide which role runs on which model, warm it up before it's needed, and make the routing visible when something goes wrong instead of debugging blind.
...
**What is the "agent infrastructure layer" or "agent harness"?**
It's the runtime that sits between a model endpoint and a working product: evaluation, tool/MCP interoperability, execution telemetry, permission boundaries, cost-aware routing, and reproducible benchmarks. It decides whether an agent actually finishes a task reliably, not just whether the underlying model scores well on a benchmark.

**How much did Emergent raise, and what is it worth?**
Emergent raised a $130 million Series C led by Creaegis at a $1.5 billion valuation in July 2026, a five-fold jump from its $300 million valuation six months earlier ([TechCrunch](https://techcrunch.com/2026/07/15/indian-ai-coding-startup-emergent-becomes-a-unicorn-just-over-a-year-after-launch/), 2026).

**How much is HCLTech investing in AI data centers?**
Up to ₹3,500 crore for AI data centers scaling to 50 MW of capacity, run through a new subsidiary and step-down subsidiaries ([HCLTech](https://www.hcltech.com/press-releases/hcltech-launches-full-stack-ai-offering-powered-new-ai-data-center-investment), 2026).

**Did a local model fleet actually beat a frontier model on coding tasks?**
On a blind 0–10 eval across coding tasks, a local Ollama-based fleet scored 8.38 against Claude Sonnet 5's 8.88 (94% of frontier quality at zero marginal model cost) and beat GPT-4o-mini's 7.50 outright. Its one clear miss was pytest unit test generation, scoring 4.0 against Sonnet 5's 8.0. Full methodology and results are in the [subagent-fleet write-up](/subagent-fleet-local-ai-compute-control-plane/).

**Is Karnataka really building a public AI university?**
Yes. Karnataka Chief Minister D.K. Shivakumar announced plans for "India's first and largest public sector-led AI University" on roughly 100 acres, alongside an AI Hub for startup incubation ([The Federal](https://thefederal.com/category/states/south/karnataka/karnataka-to-roll-out-data-centre-policy-to-power-ai-growth-next-gen-computing-250250), 2026).
