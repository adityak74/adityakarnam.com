...
description: "I set up Ollama, vLLM Metal, and SGLang on an Apple M5 Pro MacBook Pro, ran a local-serving benchmark and response-quality eval suite across the runtimes, then followed up with a Qwen 3.5 Ollama model sweep from 0.8B to 9B."
date: 2026-07-08
