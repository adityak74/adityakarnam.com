...
description: "I set up Ollama, vLLM Metal, and SGLang on an Apple M5 Pro MacBook Pro, ran the same local-serving benchmark and response-quality eval suite across all three, and used Gemma 4 as an LLM judge for visible output quality."
date: 2026-07-08
